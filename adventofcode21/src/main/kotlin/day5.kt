...
private fun map(stringLines: Array<String>) {
    val lines = stringLines.map { stringLine ->
        Line(stringLine)
    }
...
class Line(line: String) {
    ...
    init {
        ...
        val coord1 = split[0].split(",")
        val coord2 = split[1].split(",")
        this.x1 = coord1[0].toInt()
        this.y1 = coord1[1].toInt()
        this.x2 = coord2[0].toInt()
        this.y2 = coord2[1].toInt()
    }
